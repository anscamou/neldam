package sn.delivery.neldam.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, sn.delivery.neldam.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, sn.delivery.neldam.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, sn.delivery.neldam.domain.Payment.class.getName());
