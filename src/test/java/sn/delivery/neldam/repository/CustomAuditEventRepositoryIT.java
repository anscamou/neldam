...
import static sn.delivery.neldam.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import sn.delivery.neldam.config.audit.AuditEventConverter;
import sn.delivery.neldam.domain.PersistentAuditEvent;
